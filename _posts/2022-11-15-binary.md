...
<script>
    ...
    function setConversions(binary) {
        ...
        // Create background color string
        let hexa = document.getElementById('hexadecimal').innerHTML;
        let hashtag = "#";
        let color_string = hashtag.concat(hexa);
        document.body.style.backgroundColor = color_string;
        document.getElementById('colorbox').style.backgroundColor = color_string;
    }
    //
